...
class Itemlist(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    category = models.ForeignKey(Categorylist, db_column='Category', blank=True, null=True, related_name="items",on_delete=models.CASCADE)  # Field name made lowercase.
...
class Foodorder(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    customerid = models.ForeignKey('Users', models.DO_NOTHING, db_column='CustomerID', blank=True, null=True, related_name="orders")  # Field name made lowercase.
    ...
    orderdate = models.DateTimeField(db_column='OrderDate', blank=True, null=True, auto_now_add=True)  # Field name made lowercase.
...
class Users(models.Model):
    authuser = models.ForeignKey('AuthUser', models.DO_NOTHING, db_column='AuthUser', blank=True, default=2)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=255, blank=True, null=True)  # Field name made lowercase.
    username = models.CharField(db_column='UserName', max_length=255, blank=True, null=True)  # Field name made lowercase.
    address = models.CharField(db_column='Address', max_length=300, blank=True, null=True)  # Field name made lowercase.
    pincode = models.CharField(db_column='Pincode', max_length=10, blank=True, null=True)  # Field name made lowercase.
